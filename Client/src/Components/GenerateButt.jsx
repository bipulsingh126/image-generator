...
const GenerateButt = () => {
  return (
    <div className=" pb-20 flex flex-col justify-center items-center ">
      <h1 className=" text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-neutral-800 py-6 md:py-16 lg:py-20 " style={{ textShadow: "0 2px 4px rgba(0, 0, 0, 0.15)" }}>
        {" "}
